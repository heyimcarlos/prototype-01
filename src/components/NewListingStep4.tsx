...
const NewListingStep4 = ({ setStep }) => {
  ...
  return (
    <div className="w-full h-[calc(100vh-68px)]  scroll-smooth">
      <div className="flex h-full w-full flex-col  scroll-smooth">
        <div className="w-full h-auto mt-6">
          <div className="w-full flex justify-center space-x-6 pb-1.5 -mb-12 sticky z-20">
        ...
        <div className="divide-y divide-gray-200 h-full w-full">
              ...
              <div className="flex-1">
                <div>
                    ...
                    <div className="flex justify-start w-full">
                      ...
                      <p className="inline text-md text-gray-600 mt-[0.4rem] ml-3">
                        <b>
                          $
                          {Math.floor(
                            newListingState.price / newListingState.meters
                          ).toLocaleString()}
                        </b>{" "}
                        / meters<sup>2</sup>
                      </p>
                  ...
                  <h3 className=" pt-2 text-sm flex">
                    ...
                    ba |<b className="mx-1">{newListingState.meters}</b>metros
          ...
          <div className="inline flex justify-evenly pt-2">
            <a
              href="#Contacto"
          ...
          <div className="h-full w-full overflow-auto scroll-smooth">
            <div className="px-4 py-1 sm:px-0 sm:py-0 overflow-auto ">
              <div id="Contacto" className=" mb-3">
                ...
                <div className="flex flex-col overflow-auto">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0 sm:ml-6">
                    <p>
                      ...
                      Dolor autem eum, eaque enim alias, laudantium totam sed
                      quam similique omnis quidem provident in doloribus optio
                      labore esse consequatur magni? Voluptas.
                    </p>
                  </dd>
                </div>
                {/* <div className="w-full border-b-black border-[1px]" /> */}
                <Divider />
                <div id="Propiedad">
