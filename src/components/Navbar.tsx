...
import { Logo } from "@/pages/auth/sign-in";
...
const Navbar = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 z-20 relative bg-gradient-to-b from-black opacity-95">
                ...
                */}
                  {session ? (
                    <div className="flex items-center justify-between">
                      <Link
                        href={"/dashboard"}
                        className="text-base font-medium relative px-4 py-2 rounded-md hover:text-indigo-600 shadow-sm bg-custom-white hover:bg-white hover:rounded-md border border-gray-700"
                      >
                        Dashboard
                      </Link>
                      <button
