...
const RightSlideOver = ({ open, setOpen, listing }: Props) => {
    ...
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={onClose}>
        <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full">
          ...
          >
            <div>
              <Dialog.Panel className="pointer-events-auto w-screen max-w-[82.5rem] md:max-w-[calc(100vw-299px)] lg:max-w-[650px] mt-[4.98rem]">
                <div
                  id="start"
                  className="h-[calc(100vh-55.59px)] md:h-[calc(100vh-72.59px)] w-full overflow-auto scroll-smooth scroll-mt-[22rem] md:scroll-mt-[32rem] mt-[1px] md:mt-[2px] "
                >
                  <div className="absolute z-10 right-0 mt-3 mr-3 flex h-7 items-center">
                    <button
                      type="button"
                  ...
                  >
                    <div className="px-4 py-1">
                      ...
                      >
                        ...
                        <div className="mt-2 w-full flex flex-col flex-wrap space-y-1 md:space-y-2 text-sm md:text-lg lg:max-w-[20rem]">
                          <button
                            type="button"
                      ...
                      <dl id="Descripción" className="space-y-8">
                        ...
                        <div id="Exterior">
                          ...
                          <div className="flex flex-col flex-wrap mt-2 space-y-1 text-md md:text-lg">
                            {newListing.selectedExteriorAmenities.map(
                              (amen) => (
                                <div
                                  key={amen}
